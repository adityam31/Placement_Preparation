...
//Main and class automatically generated by the IDE
...
//Task was to only write the functions
...
class Stacks
{
    ...
    {
        if(sq.top1 < sq.top2)			//condition to avoid overflow
            sq.arr[++sq.top1] = x;		//normal push operation
    }
    /* The method push to push element into the stack 2*/
    void push2(int x, TwoStack sq)
    {
        if(sq.top1 < sq.top2)			//condition to avoid overflow
            sq.arr[--sq.top2] = x;		//normal push operation
    }
    /* The method pop to pop element from the stack 1 */
    //Return the popped element
    int pop1(TwoStack sq)
    {
        if(sq.top1 != -1)			//condtion to avoid underflow
            return sq.arr[sq.top1--];	//normal pop operation
    ...
    {
        if(sq.top2 != sq.size)		//condition to avoid underflow
            return sq.arr[sq.top2++];	//normal pop operation
